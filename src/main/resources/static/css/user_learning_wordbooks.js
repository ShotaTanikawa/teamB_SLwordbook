// サンプルの単語データ（ID, 名称, 意味, 詳細説明）
const wordList = [
    { id: 1, name: "単語1", describe: "意味1", detail: "説明1" },
    { id: 2, name: "単語2", describe: "意味2", detail: "説明2" },
    { id: 3, name: "単語3", describe: "意味3", detail: "説明3" },
    { id: 4, name: "単語4", describe: "意味4", detail: "説明4" },
    { id: 5, name: "単語5", describe: "意味5", detail: "説明5" }
];
